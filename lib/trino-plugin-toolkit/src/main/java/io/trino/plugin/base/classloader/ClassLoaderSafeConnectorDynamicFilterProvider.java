...
{
    private final ConnectorDynamicFilterProvider delegate;
    private final ClassLoader classLoader;

    @Inject
    public ClassLoaderSafeConnectorDynamicFilterProvider(@ForClassLoaderSafe ConnectorDynamicFilterProvider delegate, ClassLoader classLoader)
    {
